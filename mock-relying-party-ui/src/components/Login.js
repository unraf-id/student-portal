...
export default function Login({ i18nKeyPrefix = "login" }) {
  ...
  const renderSignInButton = () => {
    ...
    window.SignInWithEsignetButton?.init({
      ...
      buttonConfig: {
        shape: "soft_edges",
        labelText: t("sign_in_with_university_id"),
        width: "100%"
      },
    ...
    <>
      <div className="w-full px-8">
        <h1 className="w-full text-center title-font sm:text-3xl text-3xl mt-8 mb-8 font-medium text-gray-900">
          {t("sign_in_with_university_portal")}
        </h1>
        ...
        <div className="flex justify-left mt-5 w-full items-center text-center">
          <p className="w-full text-center justify-left">
