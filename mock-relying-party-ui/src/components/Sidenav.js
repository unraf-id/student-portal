      ...
      >
        <div className="h-full px-3 py-4">
          <div className="flex items-center justify-center col-start-1">
            <img src="images/unraf-logo.png" className="w-16 h-16 mx-4" />
            ...
            <div className="p-1 ">
              <div className="flex">
                ...
                <div className="w-full sm:w-1/2 md:w-30 p-2">
                  ...
                  { <div className="mt-12">
                     <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" title={emailAddress}>
                     {t("email")}:&nbsp;
                     <span className="truncate">
                       {emailAddress?.split("@")[0]}
                     </span>
