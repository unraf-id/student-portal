...
const get_currentCourses = () => {
  return {
    courses: [
      { name: "introToCS", instructor: "janeSmith" },
      { name: "dataStructures", instructor: "johnDoe" },
      { name: "algorithms", instructor: "emilyJohnson" },
      { name: "databaseSystems", instructor: "michaelBrown" },
      { name: "webDevelopment", instructor: "sarahDavis" },
    ],
  };
};
...
const get_nextExams = () => {
  return {
    exams: [
      { subject: "operatingSystems", date: "october20", time: "tenAM" },
      { subject: "computerNetworks", date: "october22", time: "onePM" },
      { subject: "softwareEngineering", date: "october25", time: "twoPM" },
    ],
  };
};

const get_extracurricularActivities= () => {
  return {
    activities: [
      { name: "Robotics Club", role: "Member" },
      { name: "Coding Club", role: "Actor" }, 
      { name: "Student Government", role: "Vice President" },
      { name: "Drama Society", role: "Representative" },
    ],
  };
};
